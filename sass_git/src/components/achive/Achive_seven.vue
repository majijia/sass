  ...
  methods:{
    ...
    getUrl(){ 
        ...
        this.$http.post(this.host+"scheme/generate_scheme",qs.stringify(obj)).then(result=>{
          //console.log(2201,obj)
          //console.log(222,result.data.data.list[1])
          if(result.data.errorcode==0){
            this.list=result.data.data.list[1];  
            this.date=result.data.data.list[1].arrange_date;
